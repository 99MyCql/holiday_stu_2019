...
class ConvNeuralNet:
    ...
    def train(self):
        ...
        for i in range(1501):
            ...
            #self.saver.save(self.sess,"./model/WeightFile.ckpt",global_step = 500)
        saver = tf.train.Saver()    
        saver.save(self.sess,"./model/WeightFile.ckpt")    
    ...
    def loadmodel(self):
        ...
        #self.saver = tf.train.Saver()
        if self.isTrained():
            saver.restore(self.sess, "./model/WeightFile.ckpt")
            print("load model")
        else:
