...
class AQI(object):
    ...
    def crawl_aqi(self, sleep_time=300):
        """
        ...
        while 1:
            ...
            if write_header is True:
                data.to_csv('AQI-data-07.csv', index=False, mode='a', header=True)
                write_header = False
            else:
                data.to_csv('AQI-data-07.csv', index=False, mode='a', header=False)
